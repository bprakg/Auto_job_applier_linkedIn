...
search_terms = ["Director Software Engineering OR VP Software Engineering OR Head Software Engineering OR Manager Software Engineering OR Software Engineering Manager"]
# search_terms = ["Director Software Engineering OR VP Software Engineering OR Head Software Engineering OR Manager Software Engineering OR Software Engineering Manager"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "San Francisco Bay Area" # first sf then "United States"               # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
# search_location = "United States" #next disable previous line and enable this
...
about_company_bad_words = ["perficient", "jobgether", "Crossover", "Walmart", "WGT", "Cast & Crew", "TCS", "HCL", "Wipro", "TATA", "tencent", "accenture", "polaris", "hcl"]       # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
bad_words = ["industrial", "ruby", "marketing", "fractional chief technology officer", "flight", "salesforce", "aem", "US Citizen","USA Citizen", "Embedded", "CNC", "Advisory", "No Compensation", "Equity Only", "Field CTO", "Mandarin", "Semiconductor", "lims", "voip", "emr", "rtos", "sdet", "SRE", "imaging", "sap", "manufacturing", "evtol", "cad", "crypto", "consulting", "registry management", "pre-sales", "itsm", "robotics", "professional services"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
